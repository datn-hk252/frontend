...
export default function CreateUserModal({ open, onClose, onUserCreated }: CreateUserModalProps) {
  ...
  return createPortal(
    ...
    >
      {/* Modal */}
      <div className="relative z-10 w-full max-w-lg bg-white dark:bg-[#0F1E35] border border-slate-200 dark:border-blue-500/20 rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh] my-auto">
        {/* Header */}
